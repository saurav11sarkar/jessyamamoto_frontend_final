  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Non Member Trusted Booking Fee: 25% with a $5.00 minimum\nMember Trusted Booking Fee: 12.5% with a $3.00 minimum\n\nMembers pay a reduced Trusted Booking Fee compared to non members. This means more savings on every booking when you become a JetSet Cares member.\n\nThe Trusted Booking Fee pays for identity verification, ID checks, customer support, secure messaging, reviews, trust badges, and platform maintenance.",
      },
      {
        question: "Why become a member?",
        answer:
          "Members pay a 12.5% Trusted Booking Fee with a $3.00 minimum instead of the standard 25% non member fee with a $5.00 minimum. Members may also receive access to premium features, loyalty benefits, badges, or early access perks as the platform grows.",
      },
      {
        question: "Can I use JetSet without a membership?",
        answer:
          "Yes. Families can book without a membership, but non members pay a 25% Trusted Booking Fee with a $5.00 minimum instead of the member rate of 12.5% with a $3.00 minimum.",
      },
      {
