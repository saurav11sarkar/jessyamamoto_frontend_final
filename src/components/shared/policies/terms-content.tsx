    ...
    <article className="mx-auto max-w-4xl">
      <div className="mb-10 border-b border-slate-200 pb-8">
        ...
        <div className="mt-6 space-y-1 text-sm text-slate-600">
          ...
          <p>These Terms and Conditions are entered into by and between you and JetSet Care, Ltd.</p>
          <p>
      ...
      <div className="mb-10 space-y-4 text-base leading-7 text-slate-700">
        ...
        <p>
          ...
          membership, sending a message, or otherwise accessing the platform,
                ...
                <p key={paragraph}>
                  {section.title === "36. Privacy" ? (
                    <>
                      ...
                      . The Privacy Policy explains how JetSet Cares collects,
                      uses, shares, stores, and protects personal information.
                      By using JetSet Cares, you agree to the Privacy Policy.
                    </>
                  ) : (
                    paragraph
                  )}
