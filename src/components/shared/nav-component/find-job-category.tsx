          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-500 mt-1">
                Find the perfect job opportunities across {displayCategories.length} categories
              </p>
            </div>
            {data?.meta && (
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          {(category.findCareUser?.length || 0) > 0 && (
                            <div className="flex items-center gap-1 text-xs text-gray-400">
                              ...
                              <span>
                                {category.findCareUser?.length || 0} seekers
                              </span>
                            </div>
                          )}
                          {(category.findJobUser?.length || 0) > 0 && (
                            <div className="flex items-center gap-1 text-xs text-gray-400">
                              <Briefcase className="w-3 h-3" />
                              <span>
                                {category.findJobUser?.length || 0} providers
                              </span>
                            </div>
                          )}
                        </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white border-t border-gray-100 px-6 py-4">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              {!token && (
                ...
                >
                  Login to access your job categories
...
export default FindJobCategory;
